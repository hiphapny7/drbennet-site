...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if(!cartIcon) return; const cartDropdown = cartIcon.querySelector('.group-hover\\:block'); if(!cartDropdown) return;
...
var _si=document.getElementById('search-icon'); if(_si) _si.addEventListener('click', function() {
